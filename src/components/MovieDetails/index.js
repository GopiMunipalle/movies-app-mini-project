...
function MovieDetails() {
  ...
  const renderSuccessView = () => {
        ...
        const releaseDateFormat = new Date(releaseDate).toLocaleDateString('en-US', {
            year: 'numeric',
            month: 'long',
            day: 'numeric',
          });          
        return (
          <>
            ...
            <div className="additional-information">
                ...
                <div className="info">
                  ...
                  <ul className="list-items">
                    {spokenLanguages.map(eachlanguage => (
                      <AvailableLanguages languages={eachlanguage} key={eachlanguage.id} />
                    ))}
                  </ul>
                </div>
                <div className="info">
              ...
              <Footer />
              <p style={{color:'ffffff',paddingTop:'10px',fontWeight:'bold',textAlign:'center'
              ,fontSize:'15px'}}>Contact Us</p>
            </div>
          </>
        )
  }
  ...
  return(
    <div className="movie-details-container">{renderSwitchCase()}</div>
  )
}
