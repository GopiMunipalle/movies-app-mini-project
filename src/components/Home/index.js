...
function Home(){
    ...
    const fetchTrendingApi=async()=>{
        ...
        const trendingApiResponse=await fetch('https://apis.ccbp.in/movies-app/trending-movies',options)
    ...
    const fetchOriginalApi=async()=>{
        ...
        const originalResponse=await fetch('https://apis.ccbp.in/movies-app/originals',options)
