...
function Login(){
    ...
    return(
        <div className="login-bg-container">
            <img src="https://res.cloudinary.com/dpiaz73h0/image/upload/v1697363859/Group_7399Movies_1_nkjqn8.jpg"
                alt="login website logo" className="movies-logo"/>
            ...
            <div className="login-card-container">
                ...
                <button type="submit" onClick={loginSubmit} className="login-button">{buttonText}</button>
            </div>
            </div>
        </div>
    )
